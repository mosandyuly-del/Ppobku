...
<body class="bg-slate-100 text-slate-800 antialiased min-h-screen">
    ...
    <div class="max-w-6xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div class="flex justify-between items-center bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
            <div>
                <h1 class="text-xl font-black text-slate-900 flex items-center gap-2">
                    ...
                    Panel Admin MOSANDY STORE
                </h1>
                <p class="text-xs text-slate-400 mt-1">Sistem Manajemen Transaksi & Katalog Toko Mandiri</p>
            </div>
        ...
        <div id="content-overview" class="tab-content space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm">
                    <p class="text-[10px] font-black uppercase text-slate-400">Total Produk</p>
                    <h3 class="text-2xl font-black text-slate-900 mt-1">{{ $totalProducts }}</h3>
                    <p class="text-[11px] text-emerald-600 font-bold mt-1">✓ {{ $activeProductsCount }} Aktif di Toko</p>
                </div>
                <div class="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm">
                    ...
                    <p class="text-[11px] text-slate-400 font-bold mt-1">Riwayat Transaksi Masuk</p>
                </div>
                <div class="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm">
                    <p class="text-[10px] font-black uppercase text-slate-400">Sistem Pembayaran</p>
                    <h3 class="text-base font-black text-emerald-600 mt-1">QRIS DANA (Mosandy cell)</h3>
                    <p class="text-[11px] text-slate-400 font-bold mt-1">Konfirmasi Otomatis WhatsApp</p>
                </div>
            </div>
        ...
        <div id="content-transactions" class="tab-content space-y-4 hidden">
            <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 space-y-4">
                <h2 class="text-sm font-extrabold text-slate-900 uppercase">Kelola Transaksi Masuk</h2>
                <div class="overflow-x-auto">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 space-y-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        <span class="w-3 h-3 bg-blue-600 rounded-full"></span>
                        <h2 class="text-sm font-extrabold text-slate-900 uppercase">Tambah Produk Baru</h2>
                    </div>
                </div>
